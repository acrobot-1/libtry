...
import _assertThisInitialized from "/home/virandry/accordium/project/libtry/node_modules/@babel/runtime/helpers/esm/assertThisInitialized";
  ...
  _createClass(AutoCompleteInput, [{
    ...
    value: function handleKeyUp(e) {
      ...
      if (this.props.delimiters.indexOf(e.keyCode) !== -1 && !e.shiftKey) {
        var selectedValue = this.props.value; // by right it should be key in the range of 48 - 90
    ...
    get: function get() {
      if (this.props.selectedLabelsWidth) {
        return {
          width: "calc(100% - ".concat(this.props.selectedLabelsWidth + 10, "px)")
        };
      }
